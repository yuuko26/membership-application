...
@section('content')
    ...
    <div class="row row-sm">
        <div class="col-lg-12">
            <form action="{{ route('promotions.store') }}" method="post" id="createForm">
                @csrf
                <div class="card">
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" class="form-control" id="inputStartDate" name="start_date" value="{{old('start_date', '')}}" placeholder="Start Date">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" class="form-control" id="inputEndDate" name="end_date" value="{{old('end_date', '')}}" placeholder="End Date">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="status" class="form-select select-status" id="inputStatus">
                                    @foreach(\App\Models\Promotion::STATUS_SELECT as $key => $label)
                                        <option value="{{$key}}" @if($key == \App\Models\Promotion::STATUS_ACTIVE) selected @endif>{{$label}}</option>
                                    @endforeach
                                </select>
                                @error('status')
                        ...
                        <div id="tiersContainer">
                            <div class="tier-row d-flex mb-2 row">
                                <div class="col-12">
                                    <h5>Tier <span class="tier-label">1</span></h5>
                                </div>
                                <div class="form-group col-md-5">
                                    <input type="number" name="tiers[0][referral_count]" class="form-control me-2" placeholder="Enter Referral Number">
                                </div>
                                <div class="form-group col-md-5">
                                    <input type="number" min="0" step="0.01" name="tiers[0][amount]" class="form-control me-2" placeholder="Enter Amount">
                                </div>
                            </div>
                        </div>
